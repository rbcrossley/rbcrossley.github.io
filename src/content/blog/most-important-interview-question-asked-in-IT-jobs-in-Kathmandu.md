...
Firewall types (packet filter, stateful, application layer) (Firewall troubleshooting questions are also very important. I do not remember the exact question.)
IDS vs IPS
...
Snapshot concept
VERY IMPORTANT(specially if the role leans towards devops): VM vs container difference
