...
- Add 0-10 thousand increments each year you stay in the same company. Offshore companies in Nepal, which pay higher base salaries, will provide lower increments. In-house Nepali companies that provide lower base salaries will provide higher increments as you go on.
...
I do not want to bring Glassdoor data and put it here. It will not be accurate. There are some websites like [salaryinbox](https://salaryinbox.com/) in Nepal. But I do not trust them for their collected data.
...
Generally, Development is the team that brings revenue for the company.  And support is something that the company has to do in order to keep the product alive. It does not generate new business.

That is the reason why the salaries of the development team will usually be much higher than their support counterpart.

Examples of the development team:
...
SRE and PM can be thought of as hybrid roles, i.e., somewhere between support and development. Because that role revolves around both categories. They can demand higher salaries, unlike generic support work.
...
Companies that deal with clients who value certifications will make you take many certification exams. So "learning" will be there. Some of the companies that deal with such clients are Max International, Digital Network Solution(DNS), and Adex International. They will make you take many training courses and give many certification exams.

However, another form of learning, which is "implicit learning," happens when working on complex products. This is what product-based companies that work on interesting products provide.
...
To find a remote job, I have heard of a few good ways(I myself have not been able to get one).

## Way 1

Step 1: Visit [producthunt](https://www.producthunt.com/)
