...
# Who can apply
Computer Science, Computer Engineering, Electronics and Communications Engineering, BCA, BIT students can apply. Even if your degree's name is different than the ones listed above, but it is an IT degree, fill out the form. They will approve.

# Where to apply

https://recruitment.rbb.com.np/

Visit the link provided above, select the Senior Assistant (IT) job role, and fill out the form.
Filling out the form is easy if your documents are ready. You should not need any help.

# Deadline
The deadline to fill the form is 2083/03/19-2083/04/07. If you forget to fill the form in that timeframe, you can still fill the form in by 2083/04/14.

# Form fee
For 5th level aspirants, the form fee is Rs.500. For each inclusive quota, you will need to pay an extra Rs.100. Do not worry about this. The website will show you a dynamic QR code with the money you need to pay while submitting the form.
...
### Paper II Breakdown (100 Marks)

Paper II is entirely descriptive and focuses on technical knowledge.
...
I am not sure if government banks have increased the salary as per the FY 2083/84 budget, but if they have done so, the current salary of the 5th level should be 81,000 per month.
